...
const encButton = <HTMLInputElement>document.getElementById("encrypt");
const decButton = <HTMLInputElement>document.getElementById("decrypt");

const matrix: string[][] = [[], []];
const spaceArray: number[] = [];
